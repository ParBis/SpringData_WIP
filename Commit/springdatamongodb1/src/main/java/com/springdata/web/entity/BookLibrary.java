...
public class BookLibrary {
	...
	public BookLibrary(String title, double price,	int volume, String subtitle, int durationInHours) {
		this.title = title;
		this.price = price;
		this.volume = volume;
	...
	public String toString() {
		return "BookLibrary [bookId=" + bookId + ", title=" + title + ", price=" + price + ", volume=" + volume
				+ ", stPublishDate=" + stPublishDate + ", subjectId=" + subjectId + ", subtitle=" + subtitle
				+ ", durationInHours=" + durationInHours + ", bookIdSubjectId=" + bookIdSubjectId + "]";
	}
